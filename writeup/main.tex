...
to handle automatically predicted input. Table \ref{tab:convert} shows a comparsion
between the two systems. For a more fair comparsion, we also try only use \S 19 to train our system,
and in that case, our F1 score is 6.5\% higher.
...
running time of a fully lexicalized phrase structure parsing model while still
...
automatically tagged using 10-fold jackknifing \cite{collins2000} for both dependency and phrase structure trees. \cite{zhu2013fast} found this
simple technology gives an improvement of 0.4\% on English and 2.0\% on Chinese in their case. 
