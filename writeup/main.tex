...
collection of deductive rules shown in Figure~\ref{fig:cky_new}.
The deductives rules are of the form
...
by index $m$.
 ...
 this dependency parse. For all deductive rules with head $h$ and modifier
...
precompute $\langle \Left{m},\Right{m}\rangle$. Figure~\ref{fig:cky_new} shows the new set deductive rules.
