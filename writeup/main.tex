...
To apply our model on Chinese, we use the head rules complied by \newcite{ding2005machine} \footnote{\url{http://stp.lingfil.uu.se/~nivre/research/chn_headrules.txt}}. Since RedShift  does not yet have Chinese
support, we train our d-parser using TurboParser second order model \footnote{\newcite{martins2013turning} show that with third-order features, the UAS of parsing Chinese actually decreases.} trained with projective constraints.
