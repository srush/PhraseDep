...
to guide\lpkcomment{i think ``combine dependency and phrase structure parsing'' is probably better than use the word ``guide''? } phrase-structure parsers. \newcite{carreras2008tag} build a
...
\begin{table}
  ...
  \begin{tabular}{|l|ccc|}
    ...
    \textsc{ParseDep}(Sec19) & 95.9  & 95.9 & 95.9    \\
    \textsc{ParseDep}  & 97.5 &  97.8 & 97.7    \\
    \hline
