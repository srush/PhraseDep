...
the second stage refines it \cite{petrov2006learning}.
...
provides a different representations of a sentences structure \cite{collins2003head,de2008stanford,yamada2003statistical}.
...
\begin{table}
  ...
  \begin{tabular}{|l|ccrr|}
    ...
    \hline
    \hline
    CKY($< 20$)  & $\mathcal{Y}(x)$ & $O(n^5|\rules|)$ &     0.25 & 100.0  \\
    CKY(dep)    & $\mathcal{Y}(x,d)$ & $O(n^2|\rules|)$ &  76.2 & 92.9    \\
    CKY(prune1)    & - & $O(n^2|\rules|)$ &  375.9 & 92.8    \\
    CKY(both)  &  - & $O(n^2|\rules|)$ &   487.3 & 92.6 \\
    \hline
  \end{tabular}
...
Part-of-speech tagging is done using TurboTagger\footnote{\url{http://www.ark.cs.cmu.edu/TurboParser/}}. Unless otherwise noted, 
the input d-parsing is done using TurboParser  
\cite{martins2013turning}. \lpkcomment{switch to redshift now...}
...
\begin{table}
  ...
  \begin{tabular}{|l|rr|}
    ...
    \hline
    Charniak[00]      &   89.5 &  -  \\
    Stanford PCFG     &   85.5 & 5.3  \\
    Petrov[07]        &   90.1 & 8.6  \\
    Zhu[13]           &   90.3 & 39.0 \\
    Carreras[08]      &   91.1 & -    \\
    % above have no extental resource
    CJ Reranking      &   91.5 & 4.3  \\
    StanfordRNN       &   90.0 & 2.8  \\
    \ParseName        &   90.4 & 58.6 \\
    \hline
  \end{tabular}
