...
\begin{figure}
  \centering
  For a part $(\span{i, j, k}, h, m, A \rightarrow B\ C)$
  ...
  \hline
  $(A \rightarrow B\ C)$\\
  $(A \rightarrow B\ C, \TagFN{h}, \TagFN{m})$ \\
  $(A \rightarrow B\ C, \WordFN{h}, \TagFN{m})$ \\
  $(A \rightarrow B\ C, \WordFN{h})$ \\
  $(A \rightarrow B\ C, \TagFN{h})$ \\
  $(A \rightarrow B\ C, \WordFN{m})$ \\
  $(A \rightarrow B\ C, \TagFN{m})$ \\
